#!/bin/bash
# Q1_F_BST.c (levelOrderTraversal) 자동 테스트
# 사용법: ./q1_test.sh        (Q1_F_BST.c 와 같은 폴더에 두고 실행)
...
# "The resulting level-order traversal of the binary search tree is: 20 15 50"
PAT='s/.*binary search tree is: //p'

bin=$(mktemp /tmp/q1bst.XXXXXX) || exit 1
trap 'rm -f "$bin"' EXIT
...
echo
check "20 15 50 10 18 25 80"    "20 15 50 10 18 25 80"
check "50 30 70 20 40 60 80"    "50 30 70 20 40 60 80"
check "8 3 10 1 6 14 4 7 13"    "8 3 10 1 6 14 4 7 13"
