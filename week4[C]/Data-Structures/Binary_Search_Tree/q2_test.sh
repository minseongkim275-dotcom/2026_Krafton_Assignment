#!/bin/bash
# Q2_F_BST.c (inOrderTraversal) 자동 테스트
# 사용법: ./q2_test.sh        (Q2_F_BST.c 와 같은 폴더에 두고 실행)
...
# "The resulting in-order traversal of the binary search tree is: 20 15 50"
PAT='s/.*binary search tree is: //p'

bin=$(mktemp /tmp/q2bst.XXXXXX) || exit 1
trap 'rm -f "$bin"' EXIT
...
echo
check "20 15 50 10 18 25 80"    "10 15 18 20 25 50 80"
check "50 30 70 20 40 60 80"    "20 30 40 50 60 70 80"
check "8 3 10 1 6 14 4 7 13"    "1 3 4 6 7 8 10 13 14"
