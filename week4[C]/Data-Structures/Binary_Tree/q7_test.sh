#!/bin/bash
# Q7_E_BT.c (smallestValue) 자동 테스트
# 사용법: ./q7_test.sh        (Q7_E_BT.c 와 같은 폴더에 두고 실행)
...
SRC="Q7_E_BT.c"
PAT='s/.*Smallest value of the binary tree is: //p'

bin=$(mktemp /tmp/q7bt.XXXXXX) || exit 1
trap 'rm -f "$bin"' EXIT
...
echo
check "PDF 예시" "50 30 60 25 65 a a a a 10 75 a a a a" "10"
check "full7" "5 3 7 1 2 a a a a 4 8 a a a a" "1"
check "bal7" "4 2 6 1 3 a a a a 5 7 a a a a" "1"
check "odd 트리" "50 40 60 11 35 a a a a 80 85 a a a a" "11"
check "왼쪽 사슬" "1 2 a 3 a a a" "1"
check "노드 2개" "10 5 a a a" "5"
